...
public class MemberController {
	...
	@RequestMapping(value = "/member_default", method = {RequestMethod.GET, RequestMethod.POST})
	public ModelAndView MemberDefault(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new ModelAndView("/Member/member_default");
		return mv;
	}
	 ...
	 * RequestMethod.POST}) public ModelAndView MemberWriteOk2(HttpServletRequest
